...
import { openBasket } from "../../store/cart/action";
...
const Navbar: React.FC<AllProps> = ({ data, children, openBasket }) => {
  const totalCount = data.count.reduce(function(sum, current) {
    return sum + current;
  }, 0);
  return (
    <div>
